 ...
 */
alert(jogador+" use as teclas para 🔼 e para 🔽 e Enter ✅!!")
...
function fim() {
  ...
  textFont("Arial")
  textSize(36);
  text("Fim de Jogo, Meus Parabéns!", 6, 60);
  textFont("Georgia")
  textSize(22)
...
function tutorial() {
  ...
  fill(255, 255, 230)
  rect(50, 100, 500, 400);
  let tut1, tut2, tut3, tut4,tut5, tut6;
...
function recorde() {
  ...
  fill(0)
  textSize(25)
  text("Game em Desenvolvimento", 100, 140);
  textFont("Serif")
  textSize(34)
  text("[ "+jogador+" ]"+"    ➡️     "+c.highscore, 140, 240);
}
